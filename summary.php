    ...
    <div class="reservation">
      ...
      <section class="overview">
        <span class="personal-info">
          ...
          <ul class="overview-personal-info">
            <li>Naam:</li>
            <li>Dimmy Marcelissen</li>
            <li>Email*:</li>
            <li>0904540@hr.nl</li>
            <li>Telefoon*:</li>
            <li>0681155581</li>
        ...
        <span class="form-reservation">
          <h3>Reservering</h3>
          <ul class="overview-reservation">
            <li>Datum:*</li>
            <li>19 december 2015</li>
            <li>Tijd:*</li>
            <li>17:00 uur</li>
          ...
          <ul class="overview-extra-info">
            <li>Aantal kinderen tot 10 jaar:</li>
            <li>Geen</li>
          </ul>
        </span>
      </section>
      <span class="button-container">
        ...
        <a href="thanks.php">
          <button class="send-button">Verzenden</button>
        </a>
      </span>
    </div>
  </div>
